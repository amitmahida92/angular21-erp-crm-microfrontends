...
GitHub: `https://github.com/amitmahida92/angular21-erp-crm-microfrontends`
...
- Medium article draft in [docs/medium-article.md](/Users/amitm/Documents/angular-mfe/angular21-erp-crm-microfrontends/docs/medium-article.md).
...
The shell reads local remote entries from [environment.ts](/Users/amitm/Documents/angular-mfe/angular21-erp-crm-microfrontends/projects/shell-app/src/environments/environment.ts).
...
The production remote URLs live in [environment.prod.ts](/Users/amitm/Documents/angular-mfe/angular21-erp-crm-microfrontends/projects/shell-app/src/environments/environment.prod.ts). If the repo name changes, update:

- `repoName` in `environment.prod.ts`
- `baseHref` and `deployUrl` values in `angular.json`
- README and article links

Automated deployment is configured in [.github/workflows/pages.yml](/Users/amitm/Documents/angular-mfe/angular21-erp-crm-microfrontends/.github/workflows/pages.yml). In GitHub, enable Pages with **Source: GitHub Actions**.

Alternative manual deployment with `angular-cli-ghpages`:
